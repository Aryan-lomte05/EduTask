...
public class PremiumTheme {
    ...
    // Cork Board Background Colors (Light Mode)
    private static Color CORK_BACKGROUND_LIGHT = new Color(205, 170, 125);
    private static Color CORK_DARK_LIGHT = new Color(170, 135, 90);
    private static Color CORK_LIGHT_LIGHT = new Color(225, 195, 150);

    // Dark Mode Background Colors
    private static Color CORK_BACKGROUND_DARK = new Color(30, 30, 30);
    private static Color CORK_DARK_DARK = new Color(45, 45, 45);
    private static Color CORK_LIGHT_DARK = new Color(60, 60, 60);

    // ✅ DYNAMIC COLORS (change with theme)
    public static Color CORK_BACKGROUND = CORK_BACKGROUND_LIGHT;
    public static Color CORK_DARK = CORK_DARK_LIGHT;
    public static Color CORK_LIGHT = CORK_LIGHT_LIGHT;
    public static Color TEXT_PRIMARY = new Color(40, 40, 40);
    public static Color TEXT_SECONDARY = new Color(80, 80, 80);
    ...
    private static final Color STICKY_YELLOW_DARK = new Color(80, 75, 40);
    private static final Color STICKY_PINK_DARK = new Color(80, 50, 55);
    private static final Color STICKY_BLUE_DARK = new Color(50, 65, 80);
    private static final Color STICKY_GREEN_DARK = new Color(50, 80, 50);
    private static final Color STICKY_ORANGE_DARK = new Color(80, 65, 45);
    private static final Color STICKY_PURPLE_DARK = new Color(65, 50, 80);
    ...
    private static void updateThemeColors() {
        if (isDarkMode) {
            CORK_BACKGROUND = CORK_BACKGROUND_DARK;
            CORK_DARK = CORK_DARK_DARK;
            CORK_LIGHT = CORK_LIGHT_DARK;
            TEXT_PRIMARY = new Color(220, 220, 220);
            TEXT_SECONDARY = new Color(180, 180, 180);
        } else {
            CORK_BACKGROUND = CORK_BACKGROUND_LIGHT;
            CORK_DARK = CORK_DARK_LIGHT;
            CORK_LIGHT = CORK_LIGHT_LIGHT;
            TEXT_PRIMARY = new Color(40, 40, 40);
            TEXT_SECONDARY = new Color(80, 80, 80);
        }
    }

    // ✅ UPDATED: Get sticky note color by priority (supports dark mode)
    public static Color getStickyColorByPriority(int priority) {
        if (isDarkMode) {
            return switch (priority) {
                case 5 -> STICKY_PINK_DARK;
                case 4 -> STICKY_ORANGE_DARK;
                case 3 -> STICKY_YELLOW_DARK;
                case 2 -> STICKY_GREEN_DARK;
                default -> STICKY_BLUE_DARK;
            };
        }
        return switch (priority) {
            case 5 -> STICKY_PINK;
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (isDarkMode) {
                    ...
                    // Light mode cork texture (existing)
