...
public class TaskListPanel extends JPanel {
    ...
    private LocalDate currentDisplayDate;  // Track which day we're showing
    ...
    public TaskListPanel(MainFrame mainFrame, TaskService taskService) {
        ...
        this.searchService = new SearchService();
        this.noteComponents = new ArrayList<>();
        this.currentDisplayDate = LocalDate.now(); // Default to today
    ...
    private JPanel createToolbar() {
        ...
        calendarBtn.addActionListener(e -> mainFrame.openCalendarWindow());
    ...
    public void refreshTasks() {
        // Show tasks for the current display date
    ...
    // WrapLayout class (same as before)
    private static class WrapLayout extends FlowLayout {
        public WrapLayout(int align, int hgap, int vgap) {
            super(align, hgap, vgap);
        }
